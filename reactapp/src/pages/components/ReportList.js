...
export default function ReportList({data}) {
    ...
    return (
        ...
        {/* <Comment comment={{ img: 'https://thunderbird-mozilla.ru/images/big-images/kak-dobavit-uchetnuyu-zapis-v-mozilla-thunderbird/kak-dobavit-uchetnuyu-zapis-v-mozilla-thunderbird.jpg'}} key={4} /> */}
        ...
        {/* <div className="container my-5 py-5">
            ...
            <div className="col-md-12 col-lg-10 col-xl-8">
                ...
                <div className="card-footer py-3 border-0" style="background-color: #f8f9fa;">
        ...
        {/* <div classNameName="container mb-5 py-2">

                
            <div className="card bg-success col-7 mb-3">
            ...
            <div className="card bg-danger col-7 mb-3">
                <div className="card-header">
                    Quote
                </div>
                <div className="card-body">
            ...
            <div className="card bg-warning col-7 mb-3">
                <div className="card-header">
                    Quote
                </div>
                <div className="card-body">
